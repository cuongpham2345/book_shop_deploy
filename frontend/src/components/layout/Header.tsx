      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-14 gap-4">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            ...
            <span className="font-bold text-gray-900 text-base tracking-tight">BookShop</span>
          </Link>
          ...
          <form onSubmit={handleSearch} className="flex-1 hidden sm:flex max-w-md">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 bg-gray-50"
              />
            </div>
          </form>
          ...
          <div className="ml-auto flex items-center gap-1">
            <NavLink to="/books" className={({ isActive }) =>
              `hidden sm:block px-3 py-1.5 text-sm font-medium rounded-lg transition-colors ${isActive ? 'text-gray-900 bg-gray-100' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'}`
            }>
              Sách
            </NavLink>
            ...
            {isAuthenticated ? (
              <>
                <NavLink to="/cart" className={({ isActive }) =>
                  `p-2 rounded-lg transition-colors ${isActive ? 'text-gray-900 bg-gray-100' : 'text-gray-600 hover:bg-gray-50'}`
                }>
